package aerolineasmatrices;

import java.util.Scanner;

public class AerolineasMatrices {
    ...
    public static void main(String[] args) {
        ...
        for (int f = 0; f < 6; f++) {
            for (int c = 0; c < 3; c++) {
                System.out.println("Ingrese la cantidad de asientos para el "
                        + "destino: " + f + ", horario: " + c);
        ...
        while (!bandera.equalsIgnoreCase("finish")) {
            ...
            //le pido al user el destino, horario y cantidad de asientos
            ...
            System.out.println("Ingrese finish para terminar "
